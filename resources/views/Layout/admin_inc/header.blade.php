<div class="logo-container">
    <a href="#" class="logo"><span style="font-weight: bolder"><h4>EMO PHYSIOTHERAPY</h4></span>
    </a>
                    ...
                    <ul>
                        <li>
                            <a href="#" class="clearfix">
                                <figure class="image">
                                    <img src="{{asset('_admin/img/%21sample-user.jpg')}}" alt="Joseph Doe Junior" class="rounded-circle" />
                                </figure>
                        ...
                        <li>
                            <a href="#" class="clearfix">
                                <figure class="image">
                                    <img src="{{asset('_admin/img/%21sample-user.jpg')}}" alt="Joseph Junior" class="rounded-circle" />
                                </figure>
                        ...
                        <li>
                            <a href="#" class="clearfix">
                                <figure class="image">
                                    <img src="{{asset('_admin/img/%21sample-user.jpg')}}" alt="Joe Junior" class="rounded-circle" />
                                </figure>
    ...
    <div id="userbox" class="userbox">
        <a href="#" data-toggle="dropdown">
            <figure class="profile-picture">
                <img src="{{asset('_admin/img/%21logged-user.jpg')}}" alt="Joseph Doe" class="rounded-circle" data-lock-picture="{{asset('_admin/img/%21logged-user.jpg')}}" />
            </figure>
